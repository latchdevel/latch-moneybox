...
@autor Bastian Raschke <bastian.raschke@posteo.de> Copyright 2015 All rights reserved. https://github.com/bastianraschke/pyfingerprint
...
The library is inspired by the C++ library from Adafruit Industries: https://github.com/adafruit/Adafruit-Fingerprint-Sensor-Library

Modify from v1.3 on Mar 2016 by jorge11paths
